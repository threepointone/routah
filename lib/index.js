...
var Router = exports.Router = function (_Component) {
  ...
  _createClass(Router, [{
    ...
    value: function getChildContext() {
      ...
      return {
        routah: {
          history: (_context = this.props, has).call(_context, 'history') ? this.props.history : this.__routah_history__
        }
      };
    }
  }, {
    ...
    value: function render() {
      return typeof this.props.children === 'function' ? this.props.children(this.props.history || global.__routah_history__) : this.props.children;
    }
  }]);
...
var Route = exports.Route = function (_Component2) {
  ...
  function Route() {
    ...
    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(Route)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this2), _this2.refresh = function () {
      var location = arguments.length <= 0 || arguments[0] === undefined ? currentLocation(_this2.context.routah.history) : arguments[0];
  ...
  _createClass(Route, [{
    ...
    value: function componentDidMount() {
      ...
      this.disposeBefore = this.context.routah.history.listenBefore(function (location, callback) {
        var matchesCurrent = matches(_this3.props.path, h.createHref(currentLocation(h)));
      ...
      this.disposeUnload = this.context.routah.history.listenBeforeUnload(function () {
        if (matches(_this3.props.path, h.createHref(currentLocation(h)))) {
    ...
    value: function render() {
      ...
      if (this.state.matches) {
        if (this.props.component) {
          ...
          el = _react2.default.createElement(this.props.component, _extends({ location: location, history: history }, this.props.props));
        } else {
          // render callback
  ...
  _createClass(Link, [{
    ...
    value: function componentWillMount() {
      ...
      this.dispose = this.context.routah.history.listen(function (location) {
        return _this5.setState({ location: location });
      });
    }
  }, {
    key: 'render',
    ...
    value: function componentWillMount() {
      ...
      this.dispose = this.context.routah.history.listen(function (location) {
        return _this6.setState({ location: location });
      });
    }
  }, {
    key: 'componentWillUnmount',
...
var RouteStack = exports.RouteStack = function (_Component5) {
  ...
  _createClass(RouteStack, [{
    ...
    value: function componentWillMount() {
      ...
      this.dispose = this.context.routah.history.listen(function (location) {
        return _this9.setState({ location: location });
      });
    }
  }, {
    key: 'componentWillUnmount',
    ...
    value: function render() {
      ...
      return find(this.props.children, function (c) {
