...
function connectHistory(Target) {
  ...
  return _temp4 = _class2 = function (_Component2) {
    ...
    return History;
  }(_react.Component), _class2.displayName = 'Ó:' + (Target.displayName || Target.name), _class2.contextTypes = {
    history: _react.PropTypes.object
  }, _temp4;
}
  ...
  _createClass(Route, [{
    ...
    value: function componentDidMount() {
      ...
      this.disposeBefore = h.listenBefore(function (location, callback) {
        var matchesCurrent = matches(_this5.props.path, h.createPath(_this5.state.location));
        var matchesNext = matches(_this5.props.path, h.createPath(location));
      ...
      if (h.listenBeforeUnload) {
        this.disposeUnload = h.listenBeforeUnload(function () {
          if (matches(_this5.props.path, h.createPath(_this5.state.location))) {
...
var Link = exports.Link = connectHistory(_class5 = (_temp8 = _class6 = function (_Component4) {
  ...
  _createClass(Link, [{
    ...
    value: function render() {
      ...
      var active = h.createPath(this.props.to) === h.createPath(this.props.location);
      ...
      return _react2.default.createElement(
        ...
        _extends({
          ...
          style: active ? _extends({}, this.props.style, this.props.activeStyle) : this.props.style,
...
var RouteStack = exports.RouteStack = connectHistory(_class8 = (_temp10 = _class9 = function (_Component6) {
  ...
  _createClass(RouteStack, [{
    key: 'render',
    value: function render() {
      var url = this.context.history.createPath(this.props.location);
